...
![RAG](https://img.shields.io/badge/RAG-2563EB?style=flat-square&logoColor=white)
...
|---------|-------------|------|
| [**NVIDIA Research Assistant**](https://github.com/Shanteshvinayka18/NVIDIA_Research_Assistant) | Multi-agent AI system analyzing 500+ quarterly reports, reducing research time by 87% | LangGraph, Pinecone, FastAPI, Snowflake |
| [**Real Estate AI Platform**](https://github.com/Shanteshvinayka18/real-estate-project) | 5-stage RAG pipeline processing 11,500+ Boston properties | LangChain, GPT-4, Pinecone, Airflow |
| [**TradeTrack**](https://github.com/Shanteshvinayka18/Full-Stack-Live-Update-trading-project) | Real-time trading platform for 50K+ users with millisecond latency | FastAPI, React, MySQL, Recharts |
